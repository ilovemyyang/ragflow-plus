...
if __name__ == '__main__':
    ...
    json_url = 'https://github.com/opendatalab/MinerU/blob/release-1.3.12/magic-pdf.template.json'
    config_file_name = '/Users/zhou/Documents/GitHub/ragflow-plus/magic-pdf.json'
